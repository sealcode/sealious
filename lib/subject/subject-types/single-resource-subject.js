...
const assignAttachments = require("../attachments/attachment-assigner.js");
...
const SingleResource = function (app, collection, resource_id) {
	...
	this.get_resource = async function (context, args) {
		const item = await SingleResource.prototype.__get_resource(
			app.Datastore,
			this.collection,
			this.resource_id,
			context,
