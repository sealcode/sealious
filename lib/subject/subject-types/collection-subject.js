...
const CollectionSubject = function(collection){
...
CollectionSubject.prototype.create_resource = function(context, body){
	const self = this;
	return CollectionSubject.prototype.__create_resource(ChipManager.get_datastore_chip(), self.collection, context, body);
};
...
CollectionSubject.prototype.get_child_subject = function(key){
	...
	const single_resource_subject = new SingleResource(this.collection, resource_id);
