...
const get_output_options = function(collection, params) {
    ...
    if (params.pagination) {
        ...
        output_options.skip = (full_pagination_params.page - 1) *
            full_pagination_params.items;
        output_options.amount = parseInt(full_pagination_params.items) +
...
CollectionSubject.prototype.__list_resources = function(
    datastore,
    collection,
    context,
    params
    ...
    return collection
        .check_if_action_is_allowed(context, "retrieve")
        .then(function() {
            return collection.get_aggregation_stages(
                context,
                "retrieve",
                params
            );
