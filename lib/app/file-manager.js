...
FileManager.pure = {
	...
	get_by_id: function(datastore, upload_path, context, file_id){
		return FileManager.pure.find(datastore, upload_path, context, {id: file_id})
...
FileManager.prototype = {
	save_file(file){ return FileManager.pure.save_file(this.datastore, this.upload_path, file);},
	find(context, query){return FileManager.pure.find(this.datastore, this.upload_path, context, query);},
};
