...
module.exports = {
	...
	is_proper_value: function(context, params, new_value){
		...
		if (params){
			...
			if (isAccepted){
				...
				return Promise.reject(`It didn't fulfill the requirements: required digits - ${digits} , required capitals ${capitals}`);
			}
		} else {
			return Promise.resolve();
		}
	...
	get_aggregation_stages: require("./../../../chip-types/field-type-default-methods.js").get_aggregation_stages,
