...
ResourceType.prototype = new function(){
	...
	this._process_declaration = function(declaration){
		if(declaration){
			...
			if(declaration.access_strategy){
				var access_strategy_name = declaration.access_strategy;
			}else{
				var access_strategy_name = "public";
			}			
			this.set_access_strategy(Sealious.ChipManager.get_chip("access_strategy", access_strategy_name));
		}
	}
	...
	this.set_access_strategy = function(access_strategy){
		this.access_strategy = access_strategy;
	}
