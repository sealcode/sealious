...
ResourceTypeField.prototype = new function(){
	...
	this.full_text_search_enabled = function(){
		return this.type.full_text_search_enabled(this.params);
	}

	this.format_value = function(context, decoded_value, format){
		return this.type.format(context, this.params, decoded_value, format);
	}
