...
ResourceTypeField.prototype = new function(){
	...
	this.has_previous_value_sensitive_methods = function(){
		var old_value_sensitive_methods = this.type.old_value_sensitive_methods;
		if(old_value_sensitive_methods.encode || old_value_sensitive_methods.is_proper_value){
			return true;
		}
		return false;
	}
