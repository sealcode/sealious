...
function ResourceTypeField(declaration) {
    ...
    //var check_field_type = Sealious.ChipManager.chip_exists("field_type", this.type_name);
    try {
        ...
        throw new Sealious.Errors.DeveloperError("Not exist field_type." + this.type_name);
    }
};
