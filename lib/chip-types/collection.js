...
Collection.pure = {
	...
	set_access_strategy: function(app, field_type, strategy_declaration){
		if (typeof strategy_declaration === "string" ||
			...
			for (const action_name in strategy_declaration){
				...
				field_type.access_strategy[action_name] = new AccessStrategy(app, access_strategy);
			}
		}
	},
	get_access_strategy: function(access_strategy_map, action_name){
		return access_strategy_map[action_name] || access_strategy_map["default"];
	},
	...
	get_resource_representation: function(fields, field_type_name, context, db_document, format){
...
Collection.prototype = {
	...
	get_resource_representation(context, db_document, format){ return pure.get_resource_representation(this.fields, this.name, context, db_document, format);},
