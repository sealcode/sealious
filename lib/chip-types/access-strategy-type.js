...
AccessStrategyType.pure = {
	...
	get_pre_aggregation_stage: function(declaration, context, params){
		if(declaration.get_pre_aggregation_stage){
			return Promise.resolve(declaration.get_pre_aggregation_stage(context, params));
		}else{
			return Promise.resolve([]);
		}
	}
...
AccessStrategyType.prototype = {
	...
	get_pre_aggregation_stage(context, params){return AccessStrategyType.pure.get_pre_aggregation_stage(this.declaration, context, params);},
};
