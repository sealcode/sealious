...
Sealious.init = function(mode, layer_name){
	...
	var root_module_split = root_module.parent.id.split("/");

	while(root_module.parent && root_module_split[root_module_split.length-1] !== "mocha.js"){
		root_module = root_module.parent;
		root_module_split = root_module.parent.id.split("/");
	}
