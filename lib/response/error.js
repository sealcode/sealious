...
SealiousErrors.ServerError = function(message, data){
	var err = new SealiousErrors.Error(message, {}, data);
	err.status_message = message;
	err.is_user_fault = false;
	err.is_developer_fault = true;
...
SealiousErrors.BadSubjectPath = function(message, data){
	var err = new SealiousErrors.Error(message, {}, data);
	err.status_message = message;
	err.is_user_fault = true;
	err.type = "bad_subject";
	err.http_code = 404;
	return err;
}

SealiousErrors.BadSubjecAction = function(message, data){
	var err = new SealiousErrors.Error(message, {}, data);
	err.status_message = message;
	err.is_user_fault = true;
	err.type = "bad_subject_action";
	err.http_code = 405;
	return err;
}
