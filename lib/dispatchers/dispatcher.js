...
Dispatcher.prototype.set_datastore = function(datastore_chip){
	this.datastore_chip = datastore_chip;
};

Dispatcher.prototype.init = function(){
	this.set_datastore(Sealious.ChipManager.get_datastore_chip());
	this.process_all_core_service_methods();
	this.process_all_datastore_methods();
}

Dispatcher.prototype.process_all_core_service_methods = function(){
...
Dispatcher.prototype.process_all_datastore_methods = function(){
...
Dispatcher.prototype.process_core_service_method = function(service, service_name, method_name){
	return service[method_name].bind(service);
}


Dispatcher.prototype.process_datastore_method = function(datastore_chip, method_name){
