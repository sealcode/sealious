...
var field_type_reference = new Sealious.ChipTypes.FieldType({
	...
	is_proper_value: function(accept, reject, context, params, value){
		if (typeof value === "object") {
			...
			return Sealious.ResourceManager.get_by_id(context, supposed_resource_id)
	...
	encode: function(context, params, value_in_code){
		...
		if (value_in_code instanceof Object) {
			return Sealious.ResourceManager.create(context, value_in_code.type, value_in_code.data).then(function(resource){
	...
	decode: function(context, params, value_in_db){
		if (value_in_db === undefined) {
			...
			return Sealious.ResourceManager.get_by_id(context, value_in_db);
		}
	}
});
