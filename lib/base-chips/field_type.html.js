...
var utils = {
	...
	merge_params: function(params) {
		if (params !== undefined && params.tags !== undefined) {
			var t = params.tags;
			if (t.default_decision !== "keep" && t.default_decision !== "remove" || t.default_decision === undefined) params.tags.default_decision = "remove";
		}
		if (params !== undefined && params.attributes !== undefined) {
			var a = params.attributes;
			if (a.default_decision !== "keep" && a.default_decision !== "remove" || a.default_decision === undefined) params.attributes.default_decision = "remove";
		}
