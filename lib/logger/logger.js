...
const logger_level = ConfigManager.get_config().logger_config.logger_level;
const logger_color = ConfigManager.get_config().logger_config.logger_color;
const logger_file = ConfigManager.get_config().logger_config.logger_file;
const logger_dirname = ConfigManager.get_config().logger_config.logger_dirname;
const logger_to_json = ConfigManager.get_config().logger_config.logger_to_json;
const logger_rotation = ConfigManager.get_config().logger_config.logger_rotation;
