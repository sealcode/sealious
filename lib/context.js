...
function Context (timestamp, ip, user_id, session_id, anonymous_session_id, anon_session_is_new){
	...
	this.anonymous_session_id = anonymous_session_id;
	this.anon_session_is_new = anon_session_is_new || false;
}
