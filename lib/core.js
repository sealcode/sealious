...
SealiousCore.prototype = new function(){
	...
	var check_version = function(package_info){
		...
		var version = pkg.version.substr(0,3);
		...
		http.get(url, function(res) {
			...
			res.on('end', function(){
				...
				Sealious.Logger.info("Latest Sealious version: ", json.version);
				if (json.version !== pkg.version) {
					Sealious.Logger.warning("Your Sealious version: ", pkg.version);
					Sealious.Logger.warning("Type in `npm install sealious` to update.")
				}
				else {
