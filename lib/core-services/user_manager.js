...
module.exports = new function(user_manager, dispatcher){
	this.name = "users";

	this.create_user = function(dispatcher, username, password){
		var user_data;
		return dispatcher.users.user_exists(username, dispatcher)
	...
	this.user_exists = function(dispatcher, username){
	...
	this.password_match = function(dispatcher, username, password){
		return new Promise(function(resolve, reject){
	...
	this.get_user_data = function(dispatcher, user_resource_id){
	...
	this.update_user_data = function(dispatcher, user_id, new_user_data){
		return dispatcher.resources.update_resource(user_id, new_user_data);
	}

	this.delete_user = function(dispatcher, user_id){
 		return new Promise(function(resolve, reject){ 			
