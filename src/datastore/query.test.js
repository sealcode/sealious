...
describe("Query", () => {
	...
	describe("Query.Not", () => {
		it("Correctly converts or to nor and vice versa", () => {
			...
			let negated_query = new Query.Not(query);
		...
		it("Correctly converts query with complex stages", () => {
			...
			const double_negated_query = new Query.Not(negated_query);
			assert.deepEqual(
		...
		function assertQueryEqualsDoubleNegatedQuery(query, negated_query) {
			const double_negated_query = new Query.Not(negated_query);
			assert.deepEqual(
				double_negated_query.toPipeline(),
				query.toPipeline()
