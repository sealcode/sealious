...
var that = this;
		...
		return dispatcher.users_user_exists(username, dispatcher)
			.then(function(result){	
				if (!result){
					...
					return dispatcher.resources_create("user_data", {username: username})
	...
	this.user_exists = function(username, dispatcher){
		return new Promise(function(resolve, reject){
			dispatcher.resources_find({username: username}, "user_data")
	...
	this.update_user_data = function(user_id, new_user_data, dispatcher){
		return dispatcher.database_query("users", "find", {user_id: user_id})
