...
io.on('connection', function(socket) {
		...
		*/
        ...
        socket.on("request", function(data){
        	...
        	DispatcherDistributedBIZ["resources_list_by_type"].apply(DispatcherDistributedBIZ, convert_to_array(arguments)).then(function(response){
...
//in local mode		
		console.log("BIZ resources_list_by_type args: ", arguments);
