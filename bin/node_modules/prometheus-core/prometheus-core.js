...
var Core = new function(){
	...
	function collect_module_settings(){
		...
		for(var i in modules_dir_contents){
			...
			//new Modules.Module(current_module_path);
	...
	this.registerChannel = function(id, info, body){
		console.log("registering channel ", id);//, ". Body:", body);
		channel_info[id] = info;
		channels[id] = body;
	}

	this.registerService = function(id, info, body){
		console.log("reginstered service ", id);//, ". Body:", body)
	...
	this.getChannel = function(id){
		console.log("getting channel of id", id);
		return channels[id];
	}

	this.getService = function(id){
		console.log("getting service of id", id);
