...
var biz_lpc_client = new function(){
	...
	this.init=function(){
		//ChipManager = require("prometheus-business-layer");
	}

	this.emit_service_event = function(service_name, event_name, event_payload, callback){
		return new Promise(function(resolve, reject){
			return ChipManager.getServices()[service_name].emit(event_name, event_payload, callback);
		});
	}
}

module.exports.distributed =  biz_rpc_client;
module.exports.local =  biz_lpc_client;