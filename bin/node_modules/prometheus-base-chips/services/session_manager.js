...
module.exports = function(session_manager){
	...
	function new_session(userdata_id){
		var session_id = generate_session_id();
		session_id_to_userdata_id[session_id] = userdata_id;
		return session_id;
	}

	function kill_session(session_id){
		delete session_id_to_userdata_id[session_id];
	}

	function get_user_id(session_id){
		if(session_id_to_userdata_id[session_id]){
			return session_id_to_userdata_id[session_id];
		}
		return false;
	}
