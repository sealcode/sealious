...
var resource_manager = new function(){
	...
	function enforce_correct_type_name(type_name){
		type_name = type_name.toString();
		if(!ResourceTypeManager.typeExists(type_name)){
			throw new Error("===ResourceManager error===: type `" + type_name + "` does not exist.");
		}		
	}

	this.newResource = function(type_name, value, callback){
		enforce_correct_type_name(type_name);
