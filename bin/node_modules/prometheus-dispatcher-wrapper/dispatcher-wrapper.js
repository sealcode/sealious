...
function DispatcherWrapper(real_dispatcher, allowed_chip_longids){
	...
	var functions_to_copy = [ "resources_update", "resources_search_resource", "users_update_user_data", "users_delete_user", "users_get_all_users","resources_find", "resources_get_access_mode","resources_edit_resource_access_mode", "resources_get_by_id", "users_create_user", "users_get_user_data", "users_password_match", "users_user_exists", "database_query"];
