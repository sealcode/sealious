...
function DispatcherWrapper(real_dispatcher, allowed_chip_longids){
	...
	var functions_to_copy = ["users_delete_user", "users_get_all_users", "users_create_user", "users_get_user_data", "users_password_match", "users_user_exists", "database_query"];
