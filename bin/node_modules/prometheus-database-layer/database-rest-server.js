...
server.route({
    ...
    handler: function (request, reply) {
        ...
        console.log("request for resource. Query=", query);
...
server.route({
    ...
    handler: function (request, reply) {
        ...
        DatabaseAccess.query(collection_name, "insert", query, options).then(function(data){
            console.log("responding to insert with ", data);
            reply(data);
        });
    }  
});
...
server.route({
    ...
    handler: function (request, reply) {
        ...
        DatabaseAccess.query(collection_name, "update", query, options).then(function(data){
            console.log("responding to update with ", data)
            reply(data);
        });
    }  
});
