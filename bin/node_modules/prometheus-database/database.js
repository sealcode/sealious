...
var DatabaseDirectAccess = new function(){
	...
	this.query = function(collection, mode, query, options, output_options){
		return mongo_access.query(collection, module, query, options, output_options);
	}
}

module.exports.direct_access = DatabaseDirectAccess;
module.exports.interface = DatabaseDirectAccess;