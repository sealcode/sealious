...
// 			var rt_user1_only = new ResourceType({
// 				name: "impossible_to_manipulate",
// 				fields: [],
// 				access_strategy: new AccessStrategyType({
...
// 				var result = rt_user1_only_subject.perform_action(new Context(0, null, 2), "create", {});
...
// 				var rt_user1_only_subject = new ResourceTypeCollectionSubject(rt_user1_only);
//
// 				var result = rt_user1_only_subject.perform_action(new Context(0, null, 1), "create", {});
...
// 			var rt_with_picky_field = new ResourceType({
// 				fields: [{
// 					name: 'value',
// 					type: new FieldType({
...
// 				var result = rt_with_picky_field_subject.perform_action(new Context(), "create", {value: "incorrect"});
// 				assert_error_type(result, "validation", done);
// 			})
//
// 			it("should not throw an error if they are", function(done){
// 				var result = rt_with_picky_field_subject.perform_action(new Context(), "create", {value: "correct"});
// 				assert_no_error(result, done)
// 			})
//
// 		})
...
// 			var simple_rt_subject = new ResourceTypeCollectionSubject(new ResourceType({
// 				fields: [
...
// 			var int = 3;
//
// 			simple_rt_subject.perform_action(new Context(), "create", {value1: text, value2: int})
...
// 			var rt_with_fancy_field = new ResourceType({
// 				fields: [{
// 					name: "value",
// 					type: new FieldType({
...
//
// 			rt_with_fancy_field_subject.perform_action(new Context(), "create", {value: "i_am"})
...
//
// 			var simple_rt_subject = new ResourceTypeCollectionSubject(new ResourceType({name: resource_type_name}))
...
// 			subject._preprocess_resource_filter(new Context(), filter)
...
// 			var subject = new ResourceTypeCollectionSubject(rt);
//
// 			var context = new Context(0, null, 1);
//
...
// 				access_strategy: {
// 					create: "public",
// 					default: new AccessStrategyType({
// 						name: "hydra",
// 						item_sensitive: true,
...
// 				p = subject.perform_action(new Context(), "create", {who_can_access: "1"});
// 				promises.push(p);
// 			}
//
// 			for (var i = accessible_amount + 1; i <= total_amount; i++){
// 				p = subject.perform_action(new Context(), "create", {who_can_access: i});
// 				promises.push(p);
// 			}
//
// 			var context = new Context(0, null, 1);
...
//
// 			for (var i = 1; i <= accessible_amount; i++){
// 				p = subject1.perform_action(new Context(), "create", {value: i});
// 				promises.push(p);
// 			}
//
// 			for (var i = accessible_amount + 1; i <= total_amount; i++){
// 				p = subject2.perform_action(new Context(), "create", {value: i});
// 				promises.push(p);
// 			}
//
// 			Promise.all(promises)
// 			.then(function(){
// 				subject1.perform_action(new Context(), "show")
...
// 				access_strategy: {
// 					default: "public",
// 					retrieve: new AccessStrategyType({
// 						item_sensitive: true,
...
// 			var subject = new ResourceTypeCollectionSubject(rt);
//
// 			subject.perform_action(new Context(), "create", {})
// 			.then(function(){
// 				subject.perform_action(new Context(), "show")
// 				.then(function(){
...
//
// 			for (var i = 1; i <= accessible_amount; i++){
// 				p = subject.perform_action(new Context(), "create", {value: "1"});
// 				promises.push(p);
// 			}
//
// 			for (var i = accessible_amount + 1; i <= total_amount; i++){
// 				p = subject.perform_action(new Context(), "create", {value: "2"});
// 				promises.push(p);
// 			}
//
// 			Promise.all(promises)
// 			.then(function(){
// 				return subject.perform_action(new Context(), "show", {filter: {value: "1"}})
...
//
// 			try {
// 				subject.perform_action(new Context(), "i_dont_exist");
